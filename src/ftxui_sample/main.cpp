...
// configuration step. It creates a namespace called `special_train`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", special_train::cmake::project_name, special_train::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", special_train::cmake::project_version);
      return EXIT_SUCCESS;
    }
